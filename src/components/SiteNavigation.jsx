...
const SiteNavigation = ({ isNavOpen, setIsNavOpen, navRef }) => {
  return (
    <div
      ref={navRef}
      className={`z-1000 fixed top-0 right-0 w-full h-full lg:h-auto lg:max-h-screen overflow-y-auto pt-24.5 px-0 pb-12 transition-all duration-500 bg-white shadow-[0_0px_50px_0_rgba(1,1,1,0.15)] ${
        isNavOpen
          ? "visible translate-x-0 lg:translate-y-0 opacity-100"
          : "invisible translate-x-full lg:translate-x-0 lg:-translate-y-100 opacity-0"
      }`}
    >
      <div id="container" className="my-0 mx-[264.px]">
        <div className="flex flex-col">
          {/* Desktop View (lg and above) */}
          <div className="hidden lg:flex items-start justify-between visible opacity-100 transition-opacity ease-in-out duration-1000">
